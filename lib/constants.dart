...
const String imageConstUrl = 'https://restaurant.wettlanoneinc.com/image/category/';
const String imageConstUrlBanner = 'https://restaurant.wettlanoneinc.com/image/banner/';
const String imageConstUrlRes = 'https://restaurant.wettlanoneinc.com/image/restaurants/';
const String imageConstUrlProduct = 'https://restaurant.wettlanoneinc.com/image/product/';
// https://restaurant.wettlanoneinc.com/image/category/banner.webp
// https://restaurant.wettlanoneinc.com/image/category/item4.jpg
//const lightRedColor =  Color(0xffFF483F);
const lightRedColor =  Color(0xff2eaae7);
const darkRedColor =  Color(0xffda00ff);
const lightGreenColor =  Color(0xff2eaae7);
const darkGreenColor =  Color(0xff2eaae7);
const lightPeachColor =  Color(0xffFECEB3);
const lightPeachColorLight =  Color(0xffFFE5CE);
const darkPeachColor =  Color(0xfff3721f);
const lightButtonGreyColor =  Color(0xffF4F4F4);
const lightblueColor =  Color(0xff89C1E8);
const lightblackColor =  Color(0xff2F2F2F);
const darkGreyTextColor =  Color(0xffC2C2C4);
const darkGreyTextColor1 =  Color(0xffAEACB2);
const authButtonColor =  Color(0xff2eaae7);
const authButtontextColor =  Color(0xffA8C234);
const primaryColor = Color(0xffda00ff);
const buttonColor = Color(0xffEAFFBE);
const forgetColor = Color(0xffEFCAAE);

const whiteColor = Color(0xffFFFFFF);

const buttonStyle = TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16);


//const primaryColor = Color(0xff290c0c);//Color(0xff37A000);
const primaryColor1 = Color(0xffda00ff);//Color(0xff37A000);
const secondaryColor1 = Color(0xff2eaae7);//Color(0xff37A000);
//const lightGreenColor = Color(0xffD9E9D1);
const lightGreyColor = Color(0xfff6f6f6);
const secondaryColor = Color(0xff2eaae7);
const secondary2Color = Color(0xff2eaae7);//Color(0xff033f7c);
const secondary3Color = Color(0xff2eaae7);//Color(0xff4565ba);
const appBarColor = Color(0xff2eaae7);//Color(0xff1564c0);
...
const threeColor1 = Color(0xffC285FF);
const fourColor = Color(0xff0877FE);
const fourColor1 = Color(0xff82BAFF);

//textSizess

double titleSize = 20;
double subTitleSize = 17;
double body12_16 = 20; // bold
...
TextStyle  body2Green = TextStyle(fontSize: 13,color: secondaryColor1);
TextStyle  body2White = TextStyle(fontSize: body12_16,color: Colors.white);

TextStyle  body3Black = TextStyle(fontSize: 13,color: secondaryColor1,fontWeight: FontWeight.w500,);
...
TextStyle  caption3Black = TextStyle(fontSize: 12,color: textColor,height: 1.3,fontWeight: FontWeight.w500);
TextStyle  caption3Red = TextStyle(fontSize: 14,color: Colors.red,height: 1.3, fontWeight: FontWeight.w600);
